...
const Account = () => {
  ...
  return (
    <div className="account-page">
      <h1 style={{ marginBottom: '2.5rem' }}>👤 Profilo Account</h1>
      
      {actionError && (
        <div style={{ padding: '1rem', background: 'rgba(239, 68, 68, 0.1)', borderLeft: '4px solid var(--danger)', marginBottom: '2rem', borderRadius: '4px', display: 'flex', justifyContent: 'space-between' }}>
      ...
      <div style={{ marginTop: '3rem', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '2rem', display: 'flex', justifyContent: 'flex-start' }}>
        <button 
          onClick={handleLogout}
          className="btn"
          style={{
            background: 'transparent', border: '1px solid var(--danger)', color: 'var(--danger)',
            padding: '0.8rem 2rem', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem'
          }}
        >
          🚪 Disconnetti (Logout)
        </button>
