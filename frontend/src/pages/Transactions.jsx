                    ...
                    <tbody>
                      {ctx.sortedTransactions.map(tx => (
                        <tr key={tx.id}>
                          ...
                          <td style={{ padding: '0.8rem' }}>€{(tx.price || 0).toLocaleString('it-IT', { minimumFractionDigits: 2, maximumFractionDigits: 4 })}</td>
                          <td style={{ padding: '0.8rem' }}>€{(tx.fees || 0).toLocaleString('it-IT', { minimumFractionDigits: 2 })}</td>
                          <td style={{ padding: '0.8rem', fontWeight: '600', color: 'white' }}>€{(tx.total || 0).toLocaleString('it-IT', { minimumFractionDigits: 2 })}</td>
