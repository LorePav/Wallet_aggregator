...
echo [1/3] Controllo aggiornamenti e Avvio del Backend...
start "Backend - Portfolio API" cmd /k "cd /d %~dp0backend & .\venv\Scripts\python.exe -m pip install -q -r requirements.txt & .\venv\Scripts\python.exe -m uvicorn main:app --reload --port 8000"
